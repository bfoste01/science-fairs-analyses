...
```{r, efaSEM1.cont.param, message=FALSE,  error=FALSE, warning=FALSE, tidy=TRUE, results = 'asis'}
# model parameters
...
```{r, efaSEM2.cont.param, message=FALSE,  error=FALSE, warning=FALSE, tidy=TRUE, results='asis'}
# model parameters
